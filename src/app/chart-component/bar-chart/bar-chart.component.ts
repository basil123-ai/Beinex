...
export class BarChartComponent implements OnInit, OnChanges {
  ...
  generateData() {
    this.chartData = [];
    // var names=['Strategic Affairs','Healthcare Workforce Sector','Healthcare Facilities','Support Services']
    for (let i = 0; i < 20; i++) {
      this.chartData.push([
        i,
  ...
  createChart() {
    let element: any = document.getElementById('d3-chart');
    ...
    let yDomain = [0, d3.max(this.data, (d: any) => d[1])];
